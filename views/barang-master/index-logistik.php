...
<div class="barang-master-index">
    ...
    <?php foreach ($datas as $stok) {
        if ($stok['stok_barang'] <= 10) { ?>
            <div class="alert alert-warning">
              <strong>Peringatan!</strong> Stok <?php echo $stok['nama_barang'] ?> hampir habis, minta ke admin untuk menambahkan data barang
            </div>
            <?php 
        }
    } 
